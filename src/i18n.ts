...
const messages: Record<Locale, Dict> = {
  zh: {
    ...
    "img.insertFailed": "图片插入失败：{err}",
    "edit.insertImage": "插入图片",
    "file.imageDialogName": "图片",
  ...
  en: {
    ...
    "img.insertFailed": "Couldn't insert image: {err}",
    "edit.insertImage": "Insert image",
    "file.imageDialogName": "Images",
    "file.dialogName": "Markdown / Text",
    "file.readError": "Couldn't open file",
    "update.title": "Sū — Update available",
